...
public class EventBusBuilder {
    ...
    //inject indexs by asm plugin
    static final List<SubscriberInfoIndex> SUBSCRIBE_INFO_INDEXES = new LinkedList<>();
    ...
    EventBusBuilder() {
        ...
        subscriberInfoIndexes.addAll(SUBSCRIBE_INFO_INDEXES);
    }
